...
Tags: online store, ecommerce, shop, shopping cart, amazon, sell online
...
ommerce.com/high-volume-stores/?utm_medium=referral&utm_source=wordpress.org&utm_campaign=wp_org_repo_listing).
...
- **Simplify sales tax**. Add [WooCommerce Tax]
...
Report bugs on the [WooCommerce GitHub repository](https://github.com/beckynayere/WooCommerce)

= Where can I request new features, themes, and extensions? = [github repository] (https://github.com/beckynayere/WooCommerce)
...
Yes, you can! Join in on our [GitHub repository](https://github.com/beckynayere/WooCommerce) 
...
* Fix - Revert fixing terms count in tracking PR as it caused product_add_publish to be triggered more than usual. [#beckynayere](https://github.com/beckynayere/WooCommerce)
* Fix - Hardening against XSS via the Product Button unescaped attribute. [#beckynayere](https://github.com/beckynayere/WooCommerce)
* Fix - Enhance escaping for block attributes. [#beckynayere](https://github.com/beckynayere/WooCommerce)
